...
const Category = () => {
  ...
  const handleCategorySubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://cloth-backend-aciv.onrender.com/category/create", { category });
      setCategory("");
      getCategories();
    } catch (err) {
  ...
  const handleSubCategorySubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://cloth-backend-aciv.onrender.com/subcategory/create", {
        subcatogry,
