...
const Category = () => {
  ...
  const handleCategorySubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://cloth-backend-iwvn.onrender.com/category/create", { category });
      setCategory("");
      getCategories();
    } catch (err) {
  ...
  const handleSubCategorySubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://cloth-backend-iwvn.onrender.com/subcategory/create", {
        subcatogry,
