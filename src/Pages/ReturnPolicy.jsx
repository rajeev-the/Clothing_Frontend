...
export default function ReturnPolicy() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p className="mb-4">
        We offer refund / exchange within the first <strong>7 days</strong> from
        the date of your purchase. If 7 days have passed since your purchase,
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          If the item that you purchased was on a sale, then the item may not be
      ...
      <p className="mb-4">
        You agree that there may be a certain category of products/items that are
        exempted from returns or refunds. Such categories of products would be
        identified to you at the time of purchase.
      </p>

      <p className="mb-4">
        For exchange/return accepted request(s) (as applicable), once your
        returned product/item is received and inspected by us, we will send you
        an email to notify you about receipt of the returned/exchanged product.
      </p>

      <p>
        If the same has been approved after the quality check at our end, your
        request (i.e. return/exchange) will be processed in accordance with our
        policies.
      </p>
    </div>
  );
