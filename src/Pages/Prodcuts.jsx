    ...
    <div className="bg-white min-h-screen p-4 md:p-6">
      ...
      <div className="flex gap-6">
        ...
        <aside className="hidden md:block w-1/5 space-y-6">
          <div>
            <h2 className="font-semibold mb-2 text-[#1B2559]">Gender</h2>
            <div className="space-y-1 text-[#1B2559]">
              <label className="block cursor-pointer">
                <input type="checkbox" className="mr-2 accent-[#E5C870]" />Men
              </label>
              <label className="block cursor-pointer">
                <input type="checkbox" className="mr-2 accent-[#E5C870]" />Women
              </label>
            </div>
          </div>
          ...
          <div>
            <h2 className="font-semibold mb-2 text-[#1B2559]">Category</h2>
            <div className="space-y-1 text-[#1B2559]">
              <label className="block cursor-pointer">
                <input type="checkbox" className="mr-2 accent-[#E5C870]" />T-Shirt
              </label>
              <label className="block cursor-pointer">
                <input type="checkbox" className="mr-2 accent-[#E5C870]" />Vest
              </label>
              <label className="block cursor-pointer">
                <input type="checkbox" className="mr-2 accent-[#E5C870]" />Hoodies
              </label>
            </div>
          </div>
          ...
          <div>
            <h2 className="font-semibold mb-2 text-[#1B2559]">Sizes</h2>
            <div className="space-y-1 text-[#1B2559]">
              {['XS', 'S', 'M', 'L', 'XL'].map((size) => (
                <label key={size} className="block cursor-pointer">
                  <input type="checkbox" className="mr-2 accent-[#E5C870]" />{size}
                </label>
              ))}
            </div>
          </div>
        ...
        <div className="flex-1">
          ...
          {/* Sort bar */}
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2 text-sm text-[#1B2559]">
              <FaFilter />
              <span>Refine your results</span>
            </div>
            <div>
              <label className="text-sm text-[#1B2559] mr-2">Sort by:</label>
              <select className="border border-[#02066F] rounded px-2 py-1 bg-[#1B2559] text-white text-sm">
