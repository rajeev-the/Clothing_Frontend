      ...
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-2xl p-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed">
            This Privacy Policy describes how <strong>Jalwa Trading Pvt Ltd</strong>
            and its affiliates (collectively "Jalwa Trading Pvt Ltd, we, our, us")
            collect, use, share, protect or otherwise process your information/personal
          ...
          <p className="text-gray-600 leading-relaxed">
            Please note that you may be able to browse certain sections of the Platform
            without registering with us. We do not offer any product/service under this
            Platform outside India and your personal data will primarily be stored and
            processed in India. By visiting this Platform, providing your information or
            availing any product/service offered on the Platform, you expressly agree to
            be bound by the terms and conditions of this Privacy Policy, the Terms of
            Use and the applicable service/product terms and conditions, and agree to be
            governed by the laws of India including but not limited to the laws
            applicable to data protection and privacy. If you do not agree please do not
        ...
        <section className="space-y-4 mt-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            personal data may be collected with your consent, such as your bank account
            or credit or debit card or other payment instrument information or biometric
          ...
          <p className="text-gray-600 leading-relaxed">
            You always have the option to not provide information, by choosing not to
            use a particular service or feature on the Platform. We may track your
            behaviour, preferences, and other information that you choose to provide on
            our Platform. This information is compiled and analysed on an aggregated
            basis. We will also collect your information related to your transactions on
            the Platform and such third-party business partner platforms. When such a
          ...
          <p className="text-gray-600 leading-relaxed">
            If you receive an email or call from a person/association claiming to be
            Jalwa Trading Pvt Ltd seeking any personal data like debit/credit card PIN,
            net-banking or mobile banking password, we request you to never provide such
        ...
        {/* Sharing */}
        <section className="space-y-4 mt-6">
          <h2 className="text-xl font-semibold text-gray-800">Sharing</h2>
          <p className="text-gray-600 leading-relaxed">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            payment partners opted by you. These disclosures may be required for us to
            provide you access to our services and products offered to you, to comply
            with our legal obligations, to enforce our user agreement, to facilitate our
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            to: enforce our Terms of Use or Privacy Policy; respond to claims that an
            advertisement, posting or other content violates the rights of a third
            party; or protect the rights, property or personal safety of our users or
            the general public.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-6">
          <h2 className="text-xl font-semibold text-gray-800">Security Precautions</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section className="space-y-4 mt-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            services, refuse or delay deletion of the account.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Once the account is deleted, you will lose access to the account. We retain
            your personal data information for a period no longer than is required for
            the purpose for which it was collected or as required under any applicable
            law. However, we may retain data related to you if we believe it may be
            necessary to prevent fraud or future abuse or for other legitimate purposes.
            We may continue to retain your data in anonymised form for analytical and
            research purposes.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            that you have the authority to do so and permit us to use the information in
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            before acting on them. However, please note that your withdrawal of consent
            will not be retrospective and will be in accordance with the Terms of Use,
            this Privacy Policy, and applicable laws. In the event you withdraw consent
            given to us under this Privacy Policy, we reserve the right to restrict or
            deny the provision of our services for which we consider such information to
            be necessary.
          </p>
        </section>
        ...
        <section className="space-y-4 mt-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            alert/notify you about the significant changes to the Privacy Policy, in the
